...
<template>
  <div
    class="dark:bg-dark-800 shadow-lg flex rounded-xl h-[500px] dark:text-white min-w-fit w-[1000px]"
  >
      ...
      <div class="flex flex-col justify-between h-full p-4">
        <div>
          <div
            ...
            :key="item.title"
            class="flex items-center hover:cursor-pointer relative px-4 transition-all rounded-md mb-4 dark:hover:bg-dark-400 hover:bg-primary-700"
            :class="{
              'dark:bg-dark-400 bg-primary-700': index + 1 === currentStep,
          ...
          >
            ...
            <div
              ...
              :class="{
                'border-blue-500': index + 1 === currentStep,
        ...
        <div>
          <BaseButton
            class="w-full dark:bg-dark-500 dark:hover:bg-dark-500/50 flex items-center justify-center gap-2 bg-primary-700 hover:bg-primary-800 transition-all text-red-500 font-bold"
            @click="signOut"
          >
            {{ $t("settings.signOut") }}
          </BaseButton>
    ...
    <div class="p-8 flex flex-col justify-between w-3/4">
      <div>
      ...
      <div class="flex justify-between mt-auto">
        <button
          v-if="currentStep !== 1"
          @click="currentStep--"
          class="bg-transparent py-2 rounded-lg text-sm text-gray-400"
          type="button"
        >
          {{ $t("setup.previous") }}
        </button>
...
h2 {
  @apply text-2xl text-center leading-relaxed font-bold;
}
ul {
